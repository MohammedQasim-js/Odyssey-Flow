...
import { DemoScenarioBar, DEMO_STEPS } from './components/common/DemoScenarioBar';
...
export default function App() {
  const [currentView, setCurrentView] = useState<'landing' | 'patient' | 'clinic'>('patient');
  ...
  const [snapshotTokenNumber, setSnapshotTokenNumber] = useState<string | null>(null);
  ...
  const handleResetDemo = () => {
    ...
    showToast('Demo dataset and simulation state restored to baseline (Step 1).');
  };
  ...
  const executeDemoStep = (stepNumber: number) => {
    ...
    switch (stepNumber) {
      case 1: {
        ...
        const aarav = DataStore.getPatients().find(p => p.id === 'pat_aarav_0') || DataStore.getPatients()[0];
        DataStore.setCurrentPatient(aarav);
        setPatientTab('home');
        showToast('Step 1: Patient identity verified: Aarav Mehta (XXXX XXXX 2741).');
        break;
      }
      ...
      case 2: {
        ...
        const aaravToken = DataStore.getQueue().find(t => t.tokenNumber === 'A-27');
        if (aaravToken) {
        ...
        showToast('Step 2: Checked in for Persistent Headache at Odyssey Care Clinic. Token A-27 generated.');
        break;
      }
      ...
      case 3: {
        ...
        showToast('Step 3: Sanctuary Pulse: "Queue stable" • Position 7 • ETA ~24 min.');
        break;
      }
      ...
      case 4: {
        ...
        showToast('Step 4: Queue advancing! Serving A-23. Sanctuary Pulse: "Clinic is moving".');
        break;
      }
      ...
      case 5: {
        ...
        showToast('Step 5: Position reaches 2. Sanctuary Pulse: "Your turn is getting close".');
        break;
      }
      ...
      case 6: {
        ...
        showToast('Step 6: Pre-Consultation Snapshot automatically displayed for Token A-27 (DPS 63, Stagnation Flagged).');
        break;
      }
      ...
      case 7: {
        ...
        setSnapshotTokenNumber('A-27');
        showToast('Step 7: Queue Policy Engine applied (10m → 15m window, downstream tokens buffered +5m).');
        break;
      }
      ...
      case 8: {
        ...
        setPatientTab('pulse');
        showToast('Step 8: Doctor started consultation in Room 101. Patient sees "Your consultation is in progress".');
        break;
      }
      ...
      case 9: {
        ...
        setClinicTab('dashboard');
        showToast('Step 9: Neurology specialist referral created (REF-NEURO-27, Priority: Recommended).');
        break;
      }
      ...
      case 10: {
        ...
        showToast(`Step 10: Diagnostic Journey updated! DPS recalculated ${res.oldDps} → ${res.newDps}. Trajectory: Journey showing improvement.`);
        break;
      }
      ...
      case 11: {
        ...
        showToast('Step 11: Aarav views updated Journey tab: previous encounters, active Neurology referral, and DPS 68/100.');
        break;
      }
      ...
      case 12: {
        ...
        if (!isSplitView) setCurrentView('clinic');
        showToast('Step 12: Clinic intelligence updated: Stagnating journeys 3 → 2 (-33%), referral pipeline active.');
        break;
      }
    }
            ...
            <div className="lg:col-span-7 xl:col-span-8 flex flex-col overflow-y-auto bg-[#FBFBFC]">
              <div className="bg-stone-800 text-stone-200 border-b border-stone-700 px-4 py-2 flex items-center justify-between text-xs font-bold">
                <span className="flex items-center space-x-1.5 text-amber-300">
                  ...
                  <span>Odyssey Care Clinic — Physician &amp; Operations Station</span>
                </span>
